        ...
        <div className="row">
          ...
          <div className="hero">
            <div className="hero-title">
              <h1>Bug Tracker</h1>
              <p>
                Keep track of those pesky bugs as you <br /> collaborate with
                your team.
              </p>
        ...
        <div className="row">
          ...
          <div className="feature-container">
            <div className="feature-item">
              ...
              <h3>Label</h3>
              <p>
                Prioritize your bugs and label them appropriately. Label bugs
                that need immediate attention or something that can be taken
                care of later.
              </p>
            </div>
            <div className="feature-item">
              ...
              <h3>Track</h3>
              <p>
                Keep track and take note of current bugs that are present in
                your projects. First step to solving any problem is identifying
                one.
              </p>
            </div>
            <div className="feature-item">
              ...
              <h3>Collaborate</h3>
              <p>
                Keep your team on the same page with our board view of all
                current bugs. Work together to create effective and efficient
                solutions.
              </p>
            </div>
          </div>
          <div className="about-container">
            <div className="about-info">
              ...
              <p>
                ...
                workflow when dealing with pesky bugs. Develop with confidence
                as you identify problems and collaborate with your team to get
